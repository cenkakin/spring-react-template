...
function dependencyHandlers() {
  ...
  const dllPath = path.resolve(process.cwd(), dllPlugin.path || 'node_modules/srt-dlls');
   ...
   */
  if (!dllPlugin.dlls) {
    const manifestPath = path.resolve(dllPath, 'srtDeps.json');
...
function templateContent() {
  ...
  const dllNames = !dllPlugin.dlls ? ['srtDeps'] : Object.keys(dllPlugin.dlls);
